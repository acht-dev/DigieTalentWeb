        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <section class="body">
                        <a style="margin-bottom:10px" href="" class="btn btn-danger btn-xs pull-right"><i class="glyphicon glyphicon-trash"></i> Delete Images</a>                          
                                ...
                                <form name="formImageUpload" id="formImageUpload" enctype="multipart/form-data">
                                    <div class="modal-body ">
                                        <div class="modal_body_inner" style="text-align: center">
                                            Are you sure you want to Add this images?
                                        </div>
                                    </div>
...
<script>
        ...
        function uploadImage(config) {
            ...
            uploadImage.prototype._appendImage = function (rponse) {
                ...
                var img = '';
                img += '<div style="margin-top:30px; margin-bottom:20px" class="col-xs-10 col-sm-4 col-md-2">'
                img += '<label id="img_id_' + rponse.img_id + '" class="item_img">';
                img += '<div class="images_demo">';
                img += '<img class="img img-responsive images_demo" src="' + rponse.url + '">';
                img += '</div>';
                img += '</label>';
                img += '</div>';
