    ...
    <div class="row">
        <div class="col">
            <div class="home_content d-flex flex-row align-items-end justify-content-start">
                <div class="current_page">Silabus</div>
...
@section('intro')
<div style="padding-bottom: 0px" class="elements">
		<div class="container">
			<div class="row">
				<div class="col">
					<!-- Accordions & Tabs -->
					...
					<div class="elements_accordions_tabs">
						<center>
							<div class="cta_title text-center">Daftar Silabus Digital Talent Scholarship Tahun 2019 Kementerian Komunikasi dan Informatika Republik Indonesia</div>
						</center>
						<div class="row">
							<div class="col-lg-12">
								<div class="tabs">
									<div class="tabs_container">
										<div
											...
											<div class="tab active">Silabus Digital Talent 2019</div>
										</div>
