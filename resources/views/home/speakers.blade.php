...
@section('intro')
    <section id="team" class="pb-5">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h5 class="section-title h1">Pengajar Digital Talent Scholarship</h5>
                </div>
            </div>
            <div class="row">
    ...
    <section id="team" class="pb-5">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h5 class="section-title h1">Pengajar Pendamping</h5>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h5 class="section-title h1">Sekretariat</h5>
                </div>
            </div>
